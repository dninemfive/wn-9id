...
from script.creators.infantry_unit import InfantryUnitCreator
...
def create(ctx: ModCreationContext) -> UnitRules | None:
    ...
    with ctx.create_unit("MOT. RIFLES (DRAGON)", "US", "Rifles_half_Dragon_US") as mot_rifles_dragon:
        squad: InfantryUnitCreator = InfantryUnitCreator.copy_parent(ctx.guids, mot_rifles_dragon, 'US', (M16A2, 7), (M249, 2), (DRAGON, 1))
