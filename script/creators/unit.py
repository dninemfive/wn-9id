...
class UnitCreator(object):
    def __init__(self: Self,
                 ...
                 new_unit: UnitMetadata,
                 src_unit: str | UnitMetadata,
                 showroom_src: str | UnitMetadata | None = None,
                 button_texture_key: str | None = None,
                 msg: Message | None = None):
        self.ctx = ctx
        self.localized_name = new_unit.localized_name
        self.name_token = new_unit.name_token
        self.guid = new_unit.guid
        self.new_unit = new_unit
        self.src_unit: UnitMetadata = UnitMetadata.resolve(src_unit)
        self.showroom_src_unit: UnitMetadata = UnitMetadata.resolve(showroom_src, src_unit)
    ...
    def edit_showroom_equivalence(self: Self, ndf: List):
        ...
        unit_to_showroom_equivalent.add(k=self.new_unit.descriptor_path, v=self.showroom_src_unit.showroom_descriptor_path)
